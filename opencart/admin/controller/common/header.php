...
$this->data['text_report_customer_order_statistics'] = $this->language->get('text_report_customer_order_statistics');
...
$this->data['text_report_customer_referrer'] = $this->language->get('text_report_customer_referrer');
...
$this->data['report_customer_referrer'] = $this->url->link('report/customer_referrer', 'token=' . $this->session->data['token'], 'SSL');
$this->data['report_customer_order_statistics'] = $this->url->link('report/customer_order_statistics', 'token=' . $this->session->data['token'], 'SSL');
