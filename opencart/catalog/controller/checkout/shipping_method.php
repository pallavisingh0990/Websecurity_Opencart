...
if (isset($this->session->data['entry_referrer'])) {
			$this->data['entry_referrer'] = $this->session->data['entry_referrer'];
		} else {
			$this->data['entry_referrer'] = '';
		}
...
//referrersession:post
$this->session->data['entry_referrer'] = strip_tags($this->request->post['entry_referrer']);
			}							
		}
